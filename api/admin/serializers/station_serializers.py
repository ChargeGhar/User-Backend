...
class AdminStationSerializer(serializers.Serializer):
    ...
    latitude = serializers.DecimalField(max_digits=17, decimal_places=15, read_only=True)
    longitude = serializers.DecimalField(max_digits=18, decimal_places=15, read_only=True)
...
class UpdateStationSerializer(serializers.Serializer):
    ...
    latitude = serializers.DecimalField(max_digits=17, decimal_places=15, required=False)
    longitude = serializers.DecimalField(max_digits=18, decimal_places=15, required=False)
